class /OOP/CL_CSV_PARSER definition
  public
...
public section.
*"* public components of class /OOP/CL_CSV_PARSER
*"* do not include other source files here!!!

  type-pools ABAP .
  methods CONSTRUCTOR
    importing
      !DELEGATE type ref to /OOP/IF_CSV_PARSER_DELEGATE
      !CSVSTRING type STRING
      !SEPARATOR type C
      !SKIP_FIRST_LINE type ABAP_BOOL .
  methods PARSE
    raising
      /OOP/CX_CSV_PARSE_ERROR .
protected section.
*"* protected components of class /OOP/CL_CSV_PARSER
*"* do not include other source files here!!!
private section.
*"* private components of class /OOP/CL_CSV_PARSER
*"* do not include other source files here!!!

  constants _TEXTINDICATOR type C value '"'. "#EC NOTEXT
  data _DELEGATE type ref to /OOP/IF_CSV_PARSER_DELEGATE .
...
CLASS /OOP/CL_CSV_PARSER IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method /OOP/CL_CSV_PARSER->CONSTRUCTOR
* +-------------------------------------------------------------------------------------------------+
* | [--->] DELEGATE                       TYPE REF TO /OOP/IF_CSV_PARSER_DELEGATE
* | [--->] CSVSTRING                      TYPE        STRING
* | [--->] SEPARATOR                      TYPE        C
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method /OOP/CL_CSV_PARSER->PARSE
* +-------------------------------------------------------------------------------------------------+
* | [!CX!] /OOP/CX_CSV_PARSE_ERROR
* +--------------------------------------------------------------------------------------</SIGNATURE>
method parse.
  data msg type string.
  if _csvstring is initial.
    message e002(/oop/csv) into msg.
    raise exception type /oop/cx_csv_parse_error
      exporting
        message = msg.
  endif.
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Private Method /OOP/CL_CSV_PARSER->_LINES
* +-------------------------------------------------------------------------------------------------+
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Private Method /OOP/CL_CSV_PARSER->_PARSE_LINE
* +-------------------------------------------------------------------------------------------------+
* | [--->] LINE                           TYPE        STRING
* | [<-()] RETURNING                      TYPE        STRINGTAB
* | [!CX!] /OOP/CX_CSV_PARSE_ERROR
