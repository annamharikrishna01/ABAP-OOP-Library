class /OOP/CL_STRING_DISTANCE definition
  public
...
public section.
*"* public components of class /OOP/CL_STRING_DISTANCE
...
protected section.
*"* protected components of class /OOP/CL_STRING_DISTANCE
*"* do not include other source files here!!!
private section.
*"* private components of class /OOP/CL_STRING_DISTANCE
*"* do not include other source files here!!!
...
CLASS /OOP/CL_STRING_DISTANCE IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Static Public Method /OOP/CL_STRING_DISTANCE=>DISTANCE
* +-------------------------------------------------------------------------------------------------+
* | [--->] STRING1                        TYPE        STRING
* | [--->] STRING2                        TYPE        STRING
* | [<-()] RETURNING                      TYPE        I
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Static Private Method /OOP/CL_STRING_DISTANCE=>_MIN
* +-------------------------------------------------------------------------------------------------+
* | [--->] INT1                           TYPE        I
* | [--->] INT2                           TYPE        I
* | [--->] INT3                           TYPE        I
