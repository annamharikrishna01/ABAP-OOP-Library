class /OOP/CL_OBJECT definition
  public
  create public .

public section.
*"* public components of class /OOP/CL_OBJECT
...
protected section.
*"* protected components of class /OOP/CL_OBJECT
*"* do not include other source files here!!!
private section.
*"* private components of class /OOP/CL_OBJECT
*"* do not include other source files here!!!
ENDCLASS.



CLASS /OOP/CL_OBJECT IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method /OOP/CL_OBJECT->CLONE
* +-------------------------------------------------------------------------------------------------+
* | [<-()] RETURNING                      TYPE REF TO /OOP/CL_OBJECT
* +--------------------------------------------------------------------------------------</SIGNATURE>
method clone.
  raise exception type /oop/cx_clonenotsupported.

  " Any implementation of this method MUST follow these rules:
  " - TRUE:   x->clone( ) <> x
  " - TRUE:   x->clone( )->getclass( ) = x->getclass( )
  " - TRUE:   x->clone( )->equals( x )
  " - TRUE:   x->clone( )->hashcode( ) = x->hashcode( )
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method /OOP/CL_OBJECT->EQUALS
* +-------------------------------------------------------------------------------------------------+
* | [--->] OBJ                            TYPE REF TO /OOP/CL_OBJECT
...
method equals.
  ...
  " If you override this method, you MUST override the hashcode method too,
  " such that two objects which are equal, also have the same hashcode.

endmethod.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method /OOP/CL_OBJECT->GETCLASS
* +-------------------------------------------------------------------------------------------------+
