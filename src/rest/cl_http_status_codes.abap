class /OOP/CL_HTTP_STATUS_CODES definition
  public
...
public section.
*"* public components of class /OOP/CL_HTTP_STATUS_CODES
...
protected section.
*"* protected components of class /OOP/CL_HTTP_STATUS_CODES
*"* do not include other source files here!!!
private section.
*"* private components of class /OOP/CL_HTTP_STATUS_CODES
*"* do not include other source files here!!!
ENDCLASS.



CLASS /OOP/CL_HTTP_STATUS_CODES IMPLEMENTATION.
ENDCLASS.
